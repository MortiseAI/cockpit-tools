...
mod tests {
    ...
    use super::{
        ...
        default_model_presets, is_wakeup_model_before_5_5, prune_missing_accounts_from_state,
    ...
    fn gpt_6_sol_luna_wakeup_migration_preserves_custom_presets_and_removals() {
        use super::{
            ensure_gpt_6_sol_luna_model_presets, GPT_6_SOL_LUNA_MODEL_PRESETS_MIGRATION_ID,
        };
        let mut state = CodexWakeupState::default();
        state
            .model_preset_migrations
            .retain(|id| id != GPT_6_SOL_LUNA_MODEL_PRESETS_MIGRATION_ID);
        state
            .model_presets
